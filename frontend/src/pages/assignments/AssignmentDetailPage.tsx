    ...
    <div className="space-y-6">
      <div className="space-y-1">
        <p className="text-xs text-slate-500">
          <Link to="/classes" className="text-primary-600 hover:text-primary-700">
            Back to classes
          </Link>
        </p>
          ...
          {mySubmission ? (
            ...
            <form className="space-y-3" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <input
                  type="file"
                  className="block w-full text-xs text-slate-600 file:mr-3 file:rounded-md file:border file:border-slate-200 file:bg-slate-50 file:px-3 file:py-1 file:text-xs file:font-medium file:text-slate-700 hover:file:bg-slate-100"
                  onChange={(e) => {
                      ...
                      <td className="px-3 py-2">
                        {s.contentUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="mr-2 text-xs font-medium text-primary-600 hover:text-primary-700"
                          >
                            View
                          </a>
                        )}
            ...
            <div className="mt-4 rounded-xl bg-slate-50 p-3 text-xs">
              ...
              <form className="flex flex-col gap-2" onSubmit={handleGrade}>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    className="block w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-xs shadow-sm outline-none transition focus:border-primary-500 focus:ring-1 focus:ring-primary-500"
                    rows={3}
                    value={gradeFeedback}
